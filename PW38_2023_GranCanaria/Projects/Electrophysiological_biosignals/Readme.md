...
as these bio-signals can provide information about physiological data of the subject that can complement other applications 
...
Objective 1. Designing an interface between Slicer and Arduino to acquire electrophysiological signals.
Objective 2. Visualization of electrophysiological biosignals in Slicer in the time domain in terms of voltage amplitude. 
Objective 3. Sending commands from EMG signals to Slicer to control movements of 3D models loaded into the 3D scene.
...
2. Development of the EMG signals acquisition IDE code for the Arduino board.
...
4. Adaptation of the created module to load 3D models into the Slicer's 3D scenes.
...
![MySignalsIoT PCB developed by Libelium that acquires the electrofisiological biosignals](https://github.com/JordanOrt/EMG_Slicer/blob/1546b5817a2116dead5ebac659b9e32520a62fc6/MySiganIoT.jpg)
![EMG data visualization in the MySignals PCB - Arduino system](https://github.com/JordanOrt/EMG_Slicer/blob/1546b5817a2116dead5ebac659b9e32520a62fc6/EMG_MySignals-Arduino.mp4)
![EMG-Arduino_Plot.jpg](https://github.com/JordanOrt/EMG_Slicer/blob/1546b5817a2116dead5ebac659b9e32520a62fc6/EMG-Arduino%20Plot.png)
![Real time streamming of EMG data from Arduino to 3D Slicer](https://github.com/JordanOrt/EMG_Slicer/blob/1546b5817a2116dead5ebac659b9e32520a62fc6/EMG_Slicer.mp4)
![Example of controlling a 3D hand model by EMG signals developed in LabVIEW interface](https://github.com/JordanOrt/EMG_Slicer/blob/1546b5817a2116dead5ebac659b9e32520a62fc6/EMG_Hand_Labview.mp4)
